...
return (
    <div class='projects'>
        <div class='pitem'>
            <h1>Raw Barber</h1>
            <a class='imga' href='https://github.com/DanielLMA/MERN_Assignment_Documentation'><img border="0" alt="" width="250px" src={raw} /></a>
            ...
            <a class='links' href='https://github.com/DanielLMA/MERN_Assignment_Documentation'>Documentation</a>
            <a class='links' href='https://github.com/DanielLMA/MERN_front_end'>Front end</a>
            <a class='links' href='https://github.com/DanielLMA/MERN_back_end'>Back end</a>
        </div>

        <div class='pitem'>
            <h1>Nozoma</h1>
            <a href='https://github.com/Ashamaly/round2' class='imga'><img border="0" alt="" width="250px" src={nozoma} /></a>
            ...
            <a class='links' href='https://github.com/Ashamaly/round2'>GitHub</a>
        </div>

        <div class='pitem'>
            <h1>ChaTrade</h1>
            <a href='https://github.com/Ashamaly/chat-app' class='imga'><img border="0" alt="" width="250px" src={chatrade} /></a>
            ...
            <a class='links' href='https://github.com/Ashamaly/chat-app'>GitHub</a>
        </div>

        <div class='pitem'>
            <h1>Gazoot</h1>
            <a href='https://github.com/Ashamaly/Gazoot' class='imga'><img border="0" alt="" width="250px" src={gazoot} /></a>
            ...
            <a class='links' href='https://github.com/Ashamaly/Gazoot'>GitHub</a>
        </div>
    </div>
);
}
